...
const switchPlayer = () => players.forEach(player => player.classList.toggle('player--active'));
...
holdScore.addEventListener('click', function () {
    let actualPlayerCurrentScore = document.querySelector('.player--active .current-score');
    let actualPlayerScore = document.querySelector('.player--active .score');
    actualPlayerScore.textContent = String(Number(actualPlayerScore.textContent) +
